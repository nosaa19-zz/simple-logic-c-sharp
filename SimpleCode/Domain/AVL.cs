...
namespace SimpleCode.Domain
{
    class AVL
    {
        ...
        private TNode RecursiveInsert(TNode current, TNode n)
        {
            if (current == null)
            {
                current = n;
        ...
        private TNode Delete(TNode current, int target)
        {
            TNode parent;
            if (current == null)
            { return null; }
        ...
        private TNode Find(int target, TNode current)
        {
        ...
        private void InOrderDisplayTree(TNode current)
        {
            if (current != null)
            {
